...
export const LayoutIcon = ({ size = 20 }: { size?: number }) => (
  <Icon size={size}>
...
export const WrenchIcon = ({ size = 20 }: { size?: number }) => (
  <Icon size={size}>
    <path d="M14.7 6.3a4.9 4.9 0 0 0-6.4 6.4L3 18l3 3 5.3-5.3a4.9 4.9 0 0 0 6.4-6.4l-3.1 3.1-3-3Z" />
  </Icon>
);
...
export const SettingsIcon = ({ size = 20 }: { size?: number }) => (
  <Icon size={size}>
    ...
    <path d="m19.4 15 .1.1a2 2 0 0 1-2.8 2.8l-.1-.1a2 2 0 0 0-3.4 1.4v.2a2 2 0 0 1-4 0v-.2A2 2 0 0 0 5.8 16l-.1.1a2 2 0 0 1-2.8-2.8l.1-.1a2 2 0 0 0-1.4-3.4h-.2a2 2 0 0 1 0-4h.2A2 2 0 0 0 3 2.4l-.1-.1a2 2 0 0 1 2.8-2.8l.1.1A2 2 0 0 0 9.2 1V.8a2 2 0 0 1 4 0V1a2 2 0 0 0 3.4 1.4l.1-.1a2 2 0 0 1 2.8 2.8l-.1.1A2 2 0 0 0 20.8 8h.2a2 2 0 0 1 0 4h-.2a2 2 0 0 0-1.4 3Z" />
  </Icon>
);
...
export const CreditCardIcon = ({ size = 20 }: { size?: number }) => (
  <Icon size={size}>
    <rect x="3" y="5" width="18" height="14" rx="2" />
