    ...
    setItems([
      {
        ...
        fecha: "06/09/2026",
        tamano: "1.2 MB",
        restringido: f.get("restringido") === "on",
      },
      ...items,
    ]);
    setOpen(false);
    ...
    <DashboardLayout active="documentos">
      <div className="page-header">
        ...
        <button className="btn btn-primary" onClick={() => setOpen(true)}>
          <PlusIcon size={17} /> Subir documento
        </button>
      </div>
      <div className="metric-row">
        <Metric t="Documentos" n={items.length} />
        <Metric t="Categorías" n={cats.length} />
        <Metric
          t="Restringidos"
      ...
      <section className="panel">
        <div className="panel-toolbar">
          <div>
            ...
            <p>Formatos permitidos: PDF, DOCX, JPG y PNG · máximo 10 MB</p>
          </div>
          ...
          {filtered.map((x) => (
            <article className="document-card" key={x.id}>
              ...
              <div className="doc-actions">
                <button className="icon-action" title="Consultar">
                  <EyeIcon size={16} />
                </button>
                <button
        ...
        <form className="modal-form" onSubmit={upload}>
          <div className="form-grid">
            ...
            <label className="check-label">
              <input name="restringido" type="checkbox" /> Documento restringido
            </label>
          </div>
