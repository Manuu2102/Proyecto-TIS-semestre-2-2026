    ...
    <DashboardLayout active="finanzas">
      <div className="page-header">
        <div>
          ...
          <p>
            Consulta saldos, pagos, expensas y movimientos financieros del
            edificio.
          </p>
        </div>
      </div>
      ...
      <section className="panel">
        <div className="panel-toolbar">
          <div>
            ...
            <p>Resumen financiero del edificio</p>
          </div>
        </div>
        <div className="table-wrap">
          <table>
            ...
            <tbody>
              <tr>
                <td>
                  <strong>Expensas septiembre 2026</strong>
                  <small>Pago mensual</small>
                </td>
                <td>
                  <span className="tag">A-101</span>
                </td>
                <td>Bs. 1.280,00</td>
                <td>
